...
All API keys in this repository (prefixed with `sk-`) are **tokens issued by the OpenKeyShare gateway platform**. They are NOT upstream provider keys.

- Each key has independent rate limits and per-key quotas
...
- **Preferred**: open a private [GitHub Security Advisory](https://github.com/nexttofly/free-llm-keys/security/advisories/new). Only project maintainers can see it.
