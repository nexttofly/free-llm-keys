"""OpenKeyShare — Compare responses from different models. Usage: pip install openai && python multi_model.py"""
from openai import OpenAI

client = OpenAI(base_url="https://api.openkeyshare.dev/v1", api_key="YOUR_KEY_HERE")
